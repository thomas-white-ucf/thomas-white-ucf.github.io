...
const TextBioOne = () => {
    return (
        ...
        >
            ...
            <hr />
            <Typography variant="h5" gutterBottom>
                While assisting Professional Estimators as White Engineering's Owner
                and sole employee, I returned to the University of Central Florida
                to attend the Full Stack Web Development Bootcamp.
            </Typography>
            <hr />
            <Typography variant="h5" gutterBottom>
